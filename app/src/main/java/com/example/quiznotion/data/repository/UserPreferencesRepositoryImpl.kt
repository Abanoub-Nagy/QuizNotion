...
import com.example.quiznotion.data.util.Constant.CORRECT_ANSWERS_PREF_KEY
import com.example.quiznotion.data.util.Constant.QUESTIONS_ATTEMPTED_PREF_KEY
import com.example.quiznotion.data.util.Constant.USERNAME_PREF_KEY
...
class UserPreferencesRepositoryImpl(
    ...
    override suspend fun saveScore(
        questionAttempted: Int, correctAnswers: Int
    ) {
